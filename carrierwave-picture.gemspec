...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A simple gem for converting images to new web formats with Carriewave.}
  spec.description   = %q{Converting images to webp and progressive jpeg via imagemagic.}
